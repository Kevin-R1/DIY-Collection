...
- 3 如何搭配mosdns或者smtdns运行看你自己，服务的的agd不作为dns服务器选择无- ![img.png](img/3.png)![img.png](img/4.png)。
- 如果你用我模版记得看对应端口转发和访问端口转发如果不喜欢自行改，分别是，管理 127.0.0.1:8553.127.0.0.1:8554/监听127.0.0.1:8553.127.0.0.1:8554。
